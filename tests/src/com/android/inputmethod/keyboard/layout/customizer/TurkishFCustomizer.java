...
/**
 * Turkiye Turkish customizer for F layout.
 */
public class TurkishFCustomizer extends LayoutCustomizer {
    public TurkishFCustomizer(final Locale locale) { super(locale); }
    ...
    protected void setTurkishFKeys(final ExpectedKeyboardBuilder builder) {
        builder
                // U+011F: "ğ" LATIN SMALL LETTER G WITH BREVE
                .replaceKeyOfLabel(TurkishF.ROW1_3, key("\u011F", additionalMoreKey("3")))
                // U+0131: "ı" LATIN SMALL LETTER DOTLESS I
                .replaceKeyOfLabel(TurkishF.ROW1_4, key("\u0131", additionalMoreKey("4")))
                // U+00FC: "ü" LATIN SMALL LETTER U WITH DIAERESIS
                .replaceKeyOfLabel(TurkishF.ROW2_5, "\u00FC")
                // U+015F: "ş" LATIN SMALL LETTER S WITH CEDILLA
                .replaceKeyOfLabel(TurkishF.ROW2_11, "\u015F")
                // U+00F6: "ö" LATIN SMALL LETTER O WITH DIAERESIS
                .replaceKeyOfLabel(TurkishF.ROW3_2, "\u00F6")
                // U+00E7: "ç" LATIN SMALL LETTER C WITH CEDILLA
                .replaceKeyOfLabel(TurkishF.ROW3_5, "\u00E7");
    }
