...
public final class Turkish extends LayoutBase {
    private static final String LAYOUT_NAME = "turkish";

    public Turkish(final LayoutCustomizer customizer) {
    ...
    public static final String ROW1_8 = "ROW1_8";
    public static final String ROW1_11 = "ROW1_11";
    public static final String ROW1_12 = "ROW1_12";
    ...
    private static final ExpectedKey[][] ALPHABET_COMMON = new ExpectedKeyboardBuilder()
            .setKeysOfRow(1,
                    ...
                    key(ROW1_8, additionalMoreKey("8")),
                    key("o", additionalMoreKey("9")),
                    key("p", additionalMoreKey("0")),
                    ROW1_11,
                    ROW1_12)
            .setKeysOfRow(2, "a", "s", "d", "f", "g", "h", "j", "k", "l", ROW2_10, "i")
            .setKeysOfRow(3, "z", "x", "c", "v", "b", "n", "m", ROW3_8, ROW3_9)
            .build();
}
